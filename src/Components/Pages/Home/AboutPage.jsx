          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-20 items-center">
            <div className="relative col-span-3">
              ...
              <div className="inline-flex items-center gap-3 px-2 py-1 bg-white border border-slate-200 rounded-full mb-8 shadow-sm">
                <span className="bg-color text-white px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-wider">
                  New Era
                </span>
      ...
      {/* <section className="py-24 relative bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-20">
            <span className="text-[10px] font-black text-color uppercase tracking-[0.4em] mb-4 block">
              Core Foundations
            </span>
          ...
          >
            ...
            <div className="grid lg:grid-cols-12 gap-16 items-center relative z-20">
              ...
              <div className="lg:col-span-6 grid grid-cols-2 gap-4">
                {[
                  { label: "Active Countries", val: "45+", icon: <BiGlobe /> },
                  {
                    label: "Placements",
                    val: "500+",
                  ...
                  >
                    ...
                    <div className="relative z-10">
                      <div className="text-color text-3xl mb-4 group-hover:scale-110 transition-transform bg-white table rounded p-1">
                        {stat.icon}
                      </div>
