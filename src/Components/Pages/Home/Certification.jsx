...
const levels = [
  {
    ...
    description: "Institutional micro-structures & liquidity",
    status: "Completed",
  },
  {
    level: "02",
    title: "Execution Strategy",
    description: "Advanced technical & quantitative risk",
    status: "Completed",
  },
  {
    level: "03",
    title: "Asset Management",
    description: "Multi-asset portfolio & hedge logic",
    status: "Active",
  },
  {
    level: "04",
    title: "Fund Management",
    description: "Proprietary capital allocation rights",
    status: "Locked",
  },
];
          ...
          <div className="w-full lg:w-1/2 space-y-12">
            <div>
              ...
              <p className="text-xl text-slate-400 font-medium leading-relaxed">
                We don't sell courses; we vet talent. Our levels act as a
                rigorous filter, ensuring only the top 1% manage institutional
                funds.
              </p>
            </div>
                ...
                <div
                  ...
                  ${
                    item.status === "Locked"
                      ...
                      : "bg-slate-900/40 border-white/10 hover:border-indigo-500/50 hover:bg-slate-800/60 shadow-xl shadow-black/20"
                  }
                `}
                >
                  <div
                    ...
                    ${
                      item.status === "Locked"
                        ...
                        : "bg-white text-slate-950 group-hover:bg-[#0e5da0] group-hover:text-white shadow-[0_0_20px_rgba(255,255,255,0.1)]"
                    }
                  `}
                  >
                    {item.level}
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      {item.status === "Completed" && (
                        <BiCheckCircle className="text-emerald-500 shadow-emerald-500" />
                      )}
                    </div>
