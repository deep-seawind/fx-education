  ...
  return (
    <div className="relative group p-8 rounded-[3rem] bg-linear-to-b from-[#0e5da0] via-slate-900 to-slate-950  shadow-[0_40px_80px_-20px_rgba(0,0,0,0.6)] overflow-hidden">
      ...
      <div className="flex items-center justify-between mb-10 relative z-10">
        <h3 className="text-[10px] font-bold uppercase tracking-[0.3em] text-slate-200 flex items-center gap-2">
        ...
        <div className="flex items-center gap-2 px-3 py-1 rounded-full bg-white/5 border border-white/10">
           ...
           <span className="text-[9px] font-bold text-slate-300 uppercase tracking-widest">Live Equity</span>
        </div>
      </div>

      {/* PRIMARY STAT: MAIN BALANCE */}
      <div className="mb-8 relative z-10">
        <p className="text-[10px] font-bold uppercase tracking-widest text-slate-400 mb-2 ml-1">Total Account Balance</p>
      ...
      <div className="grid grid-cols-1 gap-4 relative z-10">
        ...
        <div className={`p-5 rounded-4xl border transition-all duration-500 ${
          ...
          <div className="flex justify-between items-center mb-1">
            <span className="text-[10px] font-bold uppercase tracking-widest text-slate-400">Unrealized PnL</span>
            <HiOutlineArrowTrendingUp className={isProfit ? "text-emerald-500" : "text-rose-500 rotate-180"} />
          </div>
          <div className={`text-2xl font-bold tracking-tight ${isProfit ? "text-emerald-400" : "text-rose-400"}`}>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="p-5 rounded-4xl bg-white/3 border border-white/5 group-hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[9px] font-bold uppercase tracking-widest text-slate-300">Open Lots</span>
            </div>
            <div className="text-xl font-bold text-white">{position || "0.00"}</div>
          </div>
          ...
          <div className="p-5 rounded-4xl bg-white/3 border border-white/5 group-hover:bg-white/5 transition-colors">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[9px] font-bold uppercase tracking-widest text-slate-300">Net Equity</span>
            </div>
            <div className="text-xl font-bold text-white">${equity.toFixed(2)}</div>
          </div>
        </div>
      </div>
