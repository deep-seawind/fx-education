  ...
  const faqs = [
    {
      ...
      answer:
        "Absolutely not. Our curriculum is structured in levels, starting from 'Foundation' for complete beginners to 'Elite SMC' for advanced traders looking for institutional edge.",
    },
    {
      ...
      answer:
        "Yes. In fact, 70% of our members join specifically to pass challenges like FTMO and E8. We provide the exact risk management models required by these firms.",
    },
    {
      ...
      answer:
        "Once you enroll, you get lifetime access to the video modules and the private Discord mastermind where we share daily market markups.",
    },
  ];
