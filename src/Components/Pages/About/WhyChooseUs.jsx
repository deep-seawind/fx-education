...
import { HiOutlinePresentationChartBar, HiOutlineAcademicCap, HiOutlineShieldCheck, HiOutlineUserGroup } from 'react-icons/hi2';
...
const WhyChooseUs = () => {
  ...
  return (
    <section className="relative py-24 bg-[#0a0d14] overflow-hidden text-white">
      {/* Background Glows */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 opacity-20 blur-[120px] rounded-full" 
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text" style={{ backgroundImage: `linear-gradient(to right, white, ${brandColor})` }}>
              Choose Our Academy.
            </span>
          </motion.h2>
        </div>
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="hidden lg:flex justify-center items-center py-20">
            ...
            >
              ...
              {/* Main Icon */}
              <div className="relative z-10 w-64 h-64 bg-slate-900 rounded-3xl border border-white/10 shadow-2xl flex items-center justify-center group overflow-hidden">
                <div className="absolute inset-0 bg-linear-to-br from-transparent to-blue-600/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                <img 
                  src="https://images.unsplash.com/photo-1611974717482-9831d6196f6a?auto=format&fit=crop&q=80&w=400" 
                  alt="Market Analysis" 
                  className="w-full h-full object-cover opacity-40 group-hover:scale-110 transition-transform duration-700"
                />
                <div className="absolute flex flex-col items-center">
                   <div className="text-5xl font-bold text-white italic tracking-tighter">NIFESD</div>
                   <div className="text-xs font-bold tracking-[0.5em] text-emerald-400">TRADING</div>
                </div>
              </div>
            </motion.div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:block">
            {features.map((item, index) => (
              ...
              >
                <div 
                  className="w-12 h-12 rounded-xl flex items-center justify-center text-2xl mb-4 shadow-lg group-hover:shadow-blue-500/20 transition-all"
                  style={{ backgroundColor: brandColor }}
                >
                  {item.icon}
                </div>
        ...
        <div className="mt-20 pt-10 border-t border-white/5 flex flex-wrap justify-center gap-12 opacity-40 grayscale hover:grayscale-0 transition-all duration-500">
           <span className="font-bold italic text-2xl tracking-tighter">METATRADER 5</span>
           <span className="font-bold italic text-2xl tracking-tighter">TRADINGVIEW</span>
           <span className="font-bold italic text-2xl tracking-tighter">FTMO FUNDED</span>
           <span className="font-bold italic text-2xl tracking-tighter">MYFOREXFUNDS</span>
        </div>
      </div>
    </section>
  );
