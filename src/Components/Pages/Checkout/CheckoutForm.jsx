    ...
    <div className="space-y-10">
      ...
      <section className="group p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_30px_60px_-15px_rgba(14,93,160,0.08)] relative">
        <div className="flex items-center gap-5 mb-10">
          <div className="w-12 h-12 rounded-2xl bg-[#0e5da0] flex items-center justify-center text-white font-semibold shadow-lg shadow-blue-200 group-hover:scale-110 transition-transform">
            1
          </div>
          <div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="space-y-3">
            <label className="flex items-center gap-2 text-[10px] font-semibold uppercase tracking-[0.15em] text-slate-400 ml-1">
              First Name
            </label>
            <input
              type="text"
              placeholder="Enter first name"
              className="w-full px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:border-[#0e5da0]/10 focus:bg-white transition-all outline-none font-semibold text-slate-700 shadow-sm placeholder:text-slate-300"
            />
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <div className="w-15 px-3 py-4 bg-slate-100 border-2 border-transparent rounded-2xl font-semibold text-slate-500 text-center">
                +91
              </div>
              <input
                type="tel"
                placeholder="00000 00000"
                className="flex-1 w-40 px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:border-[#0e5da0]/10 focus:bg-white transition-all outline-none font-semibold text-slate-700 shadow-sm placeholder:text-slate-300"
              />
            </div>
          </div>
          ...
          <div className="space-y-3">
            ...
            <div className="relative group/select">
              <select className="w-full appearance-none px-6 py-4 bg-slate-50 border-2 border-transparent rounded-2xl focus:border-[#0e5da0]/10 focus:bg-white transition-all outline-none font-semibold text-slate-700 cursor-pointer shadow-sm">
                <option>India</option>
      ...
      <section className="group p-8 rounded-[2.5rem] bg-white border border-slate-100 shadow-[0_30px_60px_-20px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_30px_60px_-15px_rgba(14,93,160,0.08)]">
        <div className="flex items-center justify-between mb-10">
          <div className="flex items-center gap-5">
            <div className="w-12 h-12 rounded-2xl bg-[#0e5da0] flex items-center justify-center text-white font-semibold shadow-lg shadow-blue-200 group-hover:rotate-6 transition-transform">
              2
            </div>
            <div>
              <h3 className="text-xl font-semibold text-slate-800">
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            ...
            >
              ...
              <h4
                className={`font-semibold text-[10px] uppercase tracking-widest mb-1 transition-colors ${
          ...
          <button className="group/btn w-full py-6 bg-[#0e5da0] text-white rounded-4xl font-semibold text-sm uppercase tracking-[0.25em] shadow-2xl shadow-blue-200 hover:shadow-blue-300 hover:-translate-y-1 active:scale-[0.98] transition-all flex items-center justify-center gap-4">
            Authorize & Proceed
