...
const VideoLesson = ({
  ...
  return (
    <div className="lg:flex gap-5 px-2 py-3">
      ...
      <div
        ...
        className={`flex-1 lg:flex items-center justify-between p-4 rounded-3xl transition-all duration-300 ${
          !isUnlocked
      ...
      >
        ...
        <div className="lg:flex items-center gap-4 flex-1 min-w-0">
          {/* Icon */}
          <div
            className={`relative w-12 h-12 rounded-2xl flex items-center justify-center shadow-sm transition-all duration-300 ${
              isCompleted
