        ...
        <div className="container mx-auto px-6 lg:px-12 mb-24">
          <div className="max-w-4xl">
            ...
            <p className="text-slate-500 text-xl max-w-2xl font-medium leading-relaxed">
              As a premier financial education institute, NIFESD ensures that your academic and financial records are protected by the same encryption standards used by global banking institutions.
            </p>
          </div>
        </div>
            ...
            <main className="lg:w-3/4 space-y-20">
              ...
              <article id="introduction" className="scroll-mt-10">
                ...
                <div className="prose prose-xl max-w-none text-slate-600 font-medium leading-relaxed">
                  <p className="mb-8">
                    The <strong>National Institute of Financial Education & Skill Development (NIFESD)</strong> recognizes the sensitivity of financial learning data. This policy establishes the global standards by which student, faculty, and stakeholder information is managed.
                  </p>
                  <div className={`p-10 border-l-[6px] rounded-r-[3rem] bg-slate-900 text-white shadow-2xl relative overflow-hidden`} style={{ borderColor: brandBlue }}>
                    ...
                    <p className="italic text-lg font-light leading-relaxed relative z-10 text-blue-100">
                      "Empowering financial literacy requires a foundation of absolute transparency. At NIFESD, your data privacy is our primary regulatory obligation."
                    </p>
                  </div>
                </div>
              </article>
                  ...
                  <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                    <div className="md:w-2/3">
                        ...
                        <p className="text-xl font-light leading-relaxed opacity-90">
                          NIFESD utilizes **Military-Grade AES-256 Encryption** for all stored data. Our servers are monitored 24/7 by cyber-security experts to prevent unauthorized access and ensure your financial skill-building journey remains a secure sanctuary.
                        </p>
                    </div>
